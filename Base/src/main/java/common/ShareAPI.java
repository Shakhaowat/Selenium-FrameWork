...
public class ShareAPI {
    ...
    public String browserstack_username = "shakhaowatbhuiya1";
    public String browserstack_accesskey = "e1pxBSusDtYvBApYspsS";
    ...
    public WebDriver getLocalDriver(String browserName, String os) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (os.equalsIgnoreCase("windows")) {
                System.setProperty("webdriver.chrome.driver", "..\\Base\\drivers\\chromedriver.exe");
                driver = new ChromeDriver();
            } else if (os.equalsIgnoreCase("mac")) {
                System.setProperty("webdriver.chrome.driver", "..\\Base\\drivers\\chromedriver");
                driver = new ChromeDriver();
            }
        }
        if (browserName.equalsIgnoreCase("firefox")) {
            if (os.equalsIgnoreCase("windows")) {
                System.setProperty("webdriver.gecko.driver", "..\\Base\\drivers\\geckodriver.exe");
                driver = new ChromeDriver();
            } else if (os.equalsIgnoreCase("mac")) {
                System.setProperty("webdriver.gecko.driver", "..\\Base\\drivers\\geckodriver");
                driver = new ChromeDriver();
            }
        }return driver;
    }
